...
class Tela03 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // já inseri o elemento de layout, agora codifique o botão próxima tela abaixo. Veja as linhas de código anteriores para o botão voltar */

        // Example for a "next screen" button, assuming it goes to a hypothetical Tela02
        /*
