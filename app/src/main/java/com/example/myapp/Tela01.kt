...
class Tela01 : AppCompatActivity() {
    ...
    private lateinit var btnProximaTela: Button // Assuming the next button has this ID

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_tela01) // Assuming the layout file is named tela01_activity.xml
